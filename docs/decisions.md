...
100. **v4 §9 structure commits: kept the git plumbing local to
    ...
    next free number as of branch time off `main`'s #99; a parallel
    v4 §7 session may also be adding entries starting at #100 on its own
    branch. Renumbering on merge is expected and left to whoever
